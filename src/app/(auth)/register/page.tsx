  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050505] p-4">
      ...
      <div className="pointer-events-none absolute inset-0 flex justify-center items-center">
        <div className="absolute top-1/4 right-1/4 h-96 w-96 rounded-full bg-cyan-500/20 blur-[120px]" />
        <div className="absolute bottom-1/4 left-1/4 h-96 w-96 rounded-full bg-purple-500/20 blur-[120px]" />
      </div>
      ...
      <GlassCard className="relative z-10 w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Join EventJini to manage your events
          </p>
        </div>
